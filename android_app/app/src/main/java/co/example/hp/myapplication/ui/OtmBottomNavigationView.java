package co.example.hp.myapplication.ui;
...
public class OtmBottomNavigationView extends BottomNavigationView {
    private Path mPath;
    ...
    public OtmBottomNavigationView(Context context) {
        super(context);
        init();
    }

    public OtmBottomNavigationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public OtmBottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
